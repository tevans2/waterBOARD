...
function TDamGraph.CalculateStartDate(time_frame: integer): TDate;
begin
  case time_frame of
    0:
      begin
...
constructor TDamGraph.Create;
begin

end;

function TDamGraph.GetGraphTitle(DamID: integer): String;
begin
  case DamID of
    1:
      Result := 'Berg River';
...
procedure TDamGraph.SetupDamData(dam_id: integer; start_date: TDate);
begin
  Self.dam_id := dam_id;
